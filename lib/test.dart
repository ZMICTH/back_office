            ...
            Expanded(
              ...
              child: _selectedReservation != null
                  ? ReservationDetails(
                      ...
                      totalOfTableList: totalOfTableList,
                      selectedTableNo: selectedTableNo,
                      roundTableController: roundTableController,
                      onCheckIn: _checkInCustomer,
                      onTableNoChanged: (newValue) {
                        setState(() {
...
class ReservationDetails extends StatelessWidget {
  final ReserveTableHistory reservation;
  final List<String> totalOfTableList;
  final String? selectedTableNo;
  final TextEditingController roundTableController;
  final VoidCallback onCheckIn;
  final ValueChanged<String?> onTableNoChanged;

  ReservationDetails({
    required this.reservation,
    required this.totalOfTableList,
    required this.selectedTableNo,
    required this.roundTableController,
    required this.onCheckIn,
    required this.onTableNoChanged,
  });
